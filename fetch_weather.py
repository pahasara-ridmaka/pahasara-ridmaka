...
if response.status_code == 200:
    ...
    weather_string = f"{emoji} {description.capitalize()}, {temp}{temp_unit} (Feels like {feels_like}{temp_unit}), Humidity: {humidity}%, Wind Speed: {wind_speed} m/s, Pressure: {pressure} hPa"
